...
def pick_numeric_col(df: pd.DataFrame, preferred_names) -> Optional[str]:
...
def load_importances_rankpct(run_dir: str, top_per_model: Optional[int] = None) -> pd.DataFrame:
    """
